...
#ifndef SBERPAYSDK_SWIFT_H
#define SBERPAYSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SberPaySDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC10SberPaySDK9SBPButton")
...
SWIFT_CLASS("_TtC10SberPaySDK8SBPError")
...
SWIFT_CLASS("_TtC10SberPaySDK5SBPay")
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL isReadyForSberPay;)
+ (BOOL)isReadyForSberPay SWIFT_WARN_UNUSED_RESULT;
